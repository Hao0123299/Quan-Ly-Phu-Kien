...
--them cot quyen
	...
	--
	UPDATE dbo.SANPHAM SET MASP = N'', TENSP = '', DVT = '', GIA = '' WHERE MASP != MASP
	DELETE dbo.SANPHAM WHERE MASP = MASP

	INSERT dbo.SANPHAM( MASP, TENSP, DVT, GIA)VALUES  ( N'', 0, 0, 0)
	go
	INSERT dbo.SANPHAM( MASP, TENSP, DVT, GIA)VALUES  ( N{0}, '1', '2', '3')          
--
